...
const TECHNIQUES: Array<{
  ...
  // Level 6
  { technique: 9, level: 8, title: "Hidden Quad", text: "Four numbers in four cells", dependencies: "7" },
  ...
  { technique: 41, level: 6, title: "Unique Rectangle Type 5", text: "UR diagonal extra", dependencies: "" },
  { technique: 54, level: 8, title: "Hidden Unique Rectangle", text: "UR with hidden pair digits", dependencies: "" },
  { technique: 55, level: 6, title: "Firework", text: "Row-column intersection pattern", dependencies: "" },
  // Level 9
